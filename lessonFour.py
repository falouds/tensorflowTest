...
check_path="./tensorflow-model/lessonFour/ch-1.ckpt"
...
model.fit(train_image,train_label_onhot,epochs=5,callbacks=[callback])


model.save("./tensorflow-model/lessonFour/modal.h5")#保存模型
model.save_weights("./tensorflow-model/lessonFour/modal_weight")
#建立新的模型用load_weights,载入权重
print("evaluation: ")
